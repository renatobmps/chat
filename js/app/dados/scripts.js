                        ...
                        scripts: [
                            {
                                ...
                                texto: `Olá, agradeço por contatar o suporte técnico Dell. Meu nome é ${this.analista.nome}. Por favor, informe o nome do titular da compra, 2 Telefones com DDD. Está com o equipamento em mãos?`
                            },
                            {
                                id: "",
                                input: [],
                        ...
                        scripts: [
                            {
                                ...
                                texto: `Vamos dar início nos testes para solucionar o problema da máquina. Caso a sessão caia, peço que NÃO retorne ao chat, eu retornarei no telefone ${this.cliente.telefone}, se eu não conseguir o contato, irei te encaminhar um e-mail e ficarei no aguardo da sua resposta.`
                            },
                            {
                                id: "email",
                                input: [
                                ...
                                titulo: `Ownership`,
                                texto: `Durante todos os procedimentos eu serei o responsável do seu caso, caso haja dúvidas ou deseje informações é só responder o e-mail que te enviei no endereço ${this.cliente.email}. Poderia confirmar o recebimento?`
                            },
                            {
                                id: "",
                                input: [],
                            ...
                            },
                            {
                                id: "entrada",
                                input: [
                                    `${this.analista.entrada}`,
                                    `${this.analista.saida}`
                                ],
                                titulo: `Retorno Via e-mail (Cliente)`,
                                texto: `Se possível de preferência das ${this.analista.entrada} até às ${this.analista.saida} que é o meu horário de trabalho. Acompanhe sempre sua caixa de entrada, pois as atualizações sobre o seu caso se dará principalmente por e-mail ou SMS.`
                            },
                        ]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        scripts: [
                            ...
                            },
                            {
                                id: "dps",
                                input: [
                                    `${this.atendimento.dps}`,
                                    `${this.atendimento.eticket}`
                                ],
                                titulo: `Chamado RTD - MIS`,
                                texto: `Agradeço por aguardar, o número do chamado é ${this.atendimento.dps}. O equipamento deve ser postado em uma Agencia dos Correios utilizando a Autorização de Postagem ${this.atendimento.eticket}. O prazo para entregar o equipamento é de 7 dias a partir de hoje. Peço que tome nota de alguns procedimentos que deve tomar antes de postar a máquina nos Correios:
                            ...
                            },
                            {
                                ...
                                input: [
                                    `${this.atendimento.dps}`,
                                    `${this.atendimento.cis}`
                                ],
                                titulo: `Chamado RTD - CIS`,
                                texto: `Agradeço por aguardar, o número do chamado é ${this.atendimento.dps}. O equipamento deverá ser levado para a prestadora PROXXI no endereço: ${this.atendimento.cis}.
